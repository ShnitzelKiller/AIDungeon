...
def play_aidungeon_2():
    ...
    while True:
        ...
        while story_manager.story is None:
            print("\n\n")
            change_config = input("Would you like to enter a new parameters now? (default: temp:  0.4, top_p: 0.9, cut_actions: true) (y/N) ")
            if change_config.lower() == "y":
                ...
                story_manager.generator.change_cut_actions(bool(int(input("Enter 1 to trim actions from output, 0 to preserve as much as possible (default 1): ") or "1")))
